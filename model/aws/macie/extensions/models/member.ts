...
// Auto-generated extension model for @swamp/aws/macie/member
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Macie Member (AWS::Macie::Member).
 *
...
const StateSchema = z.object({
  ...
  AdministratorAccountId: z.string().optional(),
...
/** Swamp extension model for Macie Member. Registered at `@swamp/aws/macie/member`. */
export const model = {
  type: "@swamp/aws/macie/member",
  version: "2026.09.15.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "Macie Member resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Macie Member",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Macie Member",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Macie Member",
        ),
      }),
    ...
    update: {
      description: "Update a Macie Member",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Macie Member",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Macie Member",
        ),
    ...
    sync: {
      description: "Sync Macie Member state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Macie Member resources",
      arguments: z.object({
      ...
      execute: async (
        ...
        const credentials = _buildCredentials(context.globalArgs);
        const { items, nextToken } = await listResources("AWS::Macie::Member", {
