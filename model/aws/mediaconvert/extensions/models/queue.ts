...
// Auto-generated extension model for @swamp/aws/mediaconvert/queue
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for MediaConvert Queue (AWS::MediaConvert::Queue).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Name: z.string().describe("The name of the queue that you are creating.")
    .optional(),
...
export const model = {
  ...
  resources: {
    state: {
      description: "MediaConvert Queue resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a MediaConvert Queue",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a MediaConvert Queue",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the MediaConvert Queue",
        ),
      }),
    ...
    update: {
      description: "Update a MediaConvert Queue",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a MediaConvert Queue",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the MediaConvert Queue",
        ),
    ...
    sync: {
      description: "Sync MediaConvert Queue state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List MediaConvert Queue resources",
      arguments: z.object({
