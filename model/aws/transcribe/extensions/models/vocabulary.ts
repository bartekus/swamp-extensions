...
// Auto-generated extension model for @swamp/aws/transcribe/vocabulary
// Do not edit manually. Re-generate with: deno task generate:aws

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Transcribe Vocabulary (AWS::Transcribe::Vocabulary).
 *
...
const GlobalArgsSchema = z.object({
  ...
  Phrases: z.array(z.string().min(0).max(256).regex(new RegExp("^.+$")))
    .describe(
  ...
  VocabularyFileUri: z.string().min(1).max(2000).regex(
...
const StateSchema = z.object({
  ...
  VocabularyFileUri: z.string().optional(),
  DataAccessRoleArn: z.string().optional(),
  VocabularyState: z.string().optional(),
...
/** Swamp extension model for Transcribe Vocabulary. Registered at `@swamp/aws/transcribe/vocabulary`. */
export const model = {
  type: "@swamp/aws/transcribe/vocabulary",
  version: "2026.09.16.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "Transcribe Vocabulary resource state",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a Transcribe Vocabulary",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a Transcribe Vocabulary",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Transcribe Vocabulary",
        ),
      }),
    ...
    update: {
      description: "Update a Transcribe Vocabulary",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    delete: {
      description: "Delete a Transcribe Vocabulary",
      arguments: z.object({
        identifier: z.string().describe(
          "The primary identifier of the Transcribe Vocabulary",
        ),
    ...
    sync: {
      description: "Sync Transcribe Vocabulary state from AWS",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const credentials = _buildCredentials(g);
    ...
    list: {
      description: "List Transcribe Vocabulary resources",
      arguments: z.object({
