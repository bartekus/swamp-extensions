...
// Auto-generated extension model for @swamp/gcp/cloudresourcemanager/capabilityconfigs
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Resource Manager CapabilityConfigs.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/capabilityConfigs/${shortName}`;
}

const BASE_URL = "https://cloudresourcemanager.googleapis.com/";

const GET_CONFIG = {
  "id": "cloudresourcemanager.folders.capabilityConfigs.get",
  "path": "v3/{+name}",
  "httpMethod": "GET",
  "parameterOrder": [
    "name",
...
const INSERT_CONFIG = {
  "id": "cloudresourcemanager.folders.capabilityConfigs.create",
...
const PATCH_CONFIG = {
  "id": "cloudresourcemanager.folders.capabilityConfigs.patch",
  "path": "v3/{+name}",
  "httpMethod": "PATCH",
  "parameterOrder": [
    "name",
...
const DELETE_CONFIG = {
  "id": "cloudresourcemanager.folders.capabilityConfigs.delete",
  "path": "v3/{+name}",
  "httpMethod": "DELETE",
  "parameterOrder": [
    "name",
...
const LIST_CONFIG = {
  "id": "cloudresourcemanager.folders.capabilityConfigs.list",
  "path": "v3/{+parent}/capabilityConfigs",
  "httpMethod": "GET",
  "parameterOrder": [
    "parent",
...
const GlobalArgsSchema = z.object({
  ...
  boundaries: z.array(z.string()).describe(
  ...
  types: z.array(
    z.enum(["TYPE_UNSPECIFIED", "APP_MANAGEMENT", "AGENT_MANAGEMENT"]),
  ).describe("Required. The CapabilityConfig types.").optional(),
  capabilityConfigId: z.string().describe(
...
export const model = {
  ...
  resources: {
    state: {
      description:
        "A CapabilityConfig allows managing experiences like applications and agents o...",
      schema: StateSchema,
      lifetime: "infinite",
  ...
  methods: {
    create: {
      description: "Create a capabilityConfigs",
      arguments: z.object({
      ...
      execute: async (args: { waitForReady?: boolean }, context: any) => {
        ...
        if (g["boundaries"] !== undefined) body["boundaries"] = g["boundaries"];
        if (g["displayName"] !== undefined) {
          body["displayName"] = g["displayName"];
        }
        if (g["managementProject"] !== undefined) {
          body["managementProject"] = g["managementProject"];
        }
        if (g["name"] !== undefined) body["name"] = g["name"];
        if (g["types"] !== undefined) body["types"] = g["types"];
        if (g["capabilityConfigId"] !== undefined) {
          params["capabilityConfigId"] = String(g["capabilityConfigId"]);
        }
    ...
    get: {
      description: "Get a capabilityConfigs",
      arguments: z.object({
        identifier: z.string().describe("The name of the capabilityConfigs"),
      }),
    ...
    update: {
      description: "Update capabilityConfigs attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific capabilityConfigs by name (e.g. one discovered by list)",
        ).optional(),
        waitForReady: z.boolean().describe(
    ...
    delete: {
      description: "Delete the capabilityConfigs",
      arguments: z.object({
        identifier: z.string().describe("The name of the capabilityConfigs"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync capabilityConfigs state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific capabilityConfigs by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List capabilityConfigs resources",
      arguments: z.object({
