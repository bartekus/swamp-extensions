...
// Auto-generated extension model for @swamp/gcp/marketingplatformadmin/usergroups
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Marketing Platform Admin UserGroups.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/userGroups/${shortName}`;
}
...
/** Swamp extension model for Google Cloud Google Marketing Platform Admin UserGroups. Registered at `@swamp/gcp/marketingplatformadmin/usergroups`. */
export const model = {
  type: "@swamp/gcp/marketingplatformadmin/usergroups",
  ...
  methods: {
    create: {
      description: "Create a userGroups",
      arguments: z.object({}),
    ...
    get: {
      description: "Get a userGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the userGroups"),
      }),
    ...
    update: {
      description: "Update userGroups attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userGroups by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    delete: {
      description: "Delete the userGroups",
      arguments: z.object({
        identifier: z.string().describe("The name of the userGroups"),
      }),
      execute: async (args: { identifier: string }, context: any) => {
    ...
    sync: {
      description: "Sync userGroups state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific userGroups by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List userGroups resources",
      arguments: z.object({
