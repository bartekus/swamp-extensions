...
// Auto-generated extension model for @swamp/gcp/marketingplatformadmin/usergroups-members
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Marketing Platform Admin UserGroups.Members.
 *
...
const GlobalArgsSchema = z.object({
  ...
  ]).describe("Optional. The role of the member in the user group.").optional(),
  ...
  userEmail: z.string().describe("Email address of the user member.")
    .optional(),
  userGroup: z.string().describe(
...
/** Swamp extension model for Google Cloud Google Marketing Platform Admin UserGroups.Members. Registered at `@swamp/gcp/marketingplatformadmin/usergroups-members`. */
export const model = {
  type: "@swamp/gcp/marketingplatformadmin/usergroups-members",
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["membershipRole"] !== undefined) {
          body["membershipRole"] = g["membershipRole"];
        }
