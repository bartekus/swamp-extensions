...
// Auto-generated extension model for @swamp/gcp/marketingplatformadmin/adminaccessbindings
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Marketing Platform Admin AdminAccessBindings.
 *
...
function buildResourceName(parent: string, shortName: string): string {
  return `${parent}/adminAccessBindings/${shortName}`;
}
...
const GlobalArgsSchema = z.object({
  ...
  userGroup: z.string().describe("Resource name of the user group.").optional(),
...
/** Swamp extension model for Google Cloud Google Marketing Platform Admin AdminAccessBindings. Registered at `@swamp/gcp/marketingplatformadmin/adminaccessbindings`. */
export const model = {
  type: "@swamp/gcp/marketingplatformadmin/adminaccessbindings",
  ...
  methods: {
    create: {
      description: "Create a adminAccessBindings",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g["organizationRoles"] !== undefined) {
          body["organizationRoles"] = g["organizationRoles"];
        }
        if (g["userEmail"] !== undefined) body["userEmail"] = g["userEmail"];
        if (g["userGroup"] !== undefined) body["userGroup"] = g["userGroup"];
    ...
    get: {
      description: "Get a adminAccessBindings",
      arguments: z.object({
        identifier: z.string().describe("The name of the adminAccessBindings"),
      }),
    ...
    update: {
      description: "Update adminAccessBindings attributes",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific adminAccessBindings by name (e.g. one discovered by list)",
        ).optional(),
      }),
      execute: async (args: { identifier?: string }, context: any) => {
        const g = context.globalArgs;
    ...
    sync: {
      description: "Sync adminAccessBindings state from GCP",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific adminAccessBindings by name (e.g. one discovered by list)",
        ).optional(),
    ...
    list: {
      description: "List adminAccessBindings resources",
      arguments: z.object({
