...
// Auto-generated extension model for @swamp/gcp/meet/spaces-members
// Do not edit manually. Re-generate with: deno task generate:gcp

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for Google Cloud Google Meet Spaces.Members.
 *
...
const GlobalArgsSchema = z.object({
  ...
  role: z.enum(["ROLE_UNSPECIFIED", "COHOST"]).describe(
...
/** Swamp extension model for Google Cloud Google Meet Spaces.Members. Registered at `@swamp/gcp/meet/spaces-members`. */
export const model = {
  type: "@swamp/gcp/meet/spaces-members",
  ...
  resources: {
    state: {
      description:
        "Users who are configured to have a role in the space. These users can join th...",
      schema: StateSchema,
      lifetime: "infinite",
    ...
    batch_update: {
      ...
      execute: async (args: Record<string, unknown>, context: any) => {
        ...
        const result = await createResource(
          baseUrl,
          {
            "id": "meet.spaces.members.batchUpdate",
