...
Use `swamp model type describe @swamp/gcp/fcm/registrations_topicsubscriptions`
...
```bash
# Create a new registrations_topicsubscriptions model
swamp model create @swamp/gcp/fcm/registrations_topicsubscriptions my-registrations_topicsubscriptions

# Edit the model to configure its properties
swamp model edit my-registrations_topicsubscriptions

# Create the resource in GCP
swamp model method run my-registrations_topicsubscriptions create

# Sync current state from GCP
swamp model method run my-registrations_topicsubscriptions sync
```
