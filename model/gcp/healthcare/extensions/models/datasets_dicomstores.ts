...
export const model = {
  ...
  upgrades: [
    ...
    },
    {
      ...
      description:
        "Removed: pubsubTopic, sendForBulkImport, pubsubTopic, bigqueryDestination, force, includeSourceStore, schemaFlattened, schemaJson, tableUri, writeDisposition",
      upgradeAttributes: (old: Record<string, unknown>) => {
        const {
          ...
          force: _force,
          includeSourceStore: _includeSourceStore,
          schemaFlattened: _schemaFlattened,
