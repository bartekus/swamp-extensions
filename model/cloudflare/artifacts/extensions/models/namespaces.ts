...
// Auto-generated extension model for @swamp/cloudflare/artifacts/namespaces
  ...
  methods: {
    create: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.namespace !== undefined) body.namespace = g.namespace;
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.namespace !== undefined) {
          filters.push(["namespace", String(g.namespace)]);
        }
        if (filters.length === 0) {
          throw new Error(
