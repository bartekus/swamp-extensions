...
Use `swamp model type describe @swamp/cloudflare/artifacts/namespaces` to see
...
swamp model create @swamp/cloudflare/artifacts/namespaces my-namespaces
