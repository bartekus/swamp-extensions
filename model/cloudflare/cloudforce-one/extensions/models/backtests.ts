...
// Auto-generated extension model for @swamp/cloudflare/cloudforce-one/backtests
// Do not edit manually. Re-generate with: deno task generate:cloudflare

// deno-lint-ignore-file no-explicit-any

/**
 * Swamp extension model for a Cloudflare Backtests.
 *
...
const GlobalArgsSchema = z.object({
  ...
  backtest_days: z.number().int().min(1).max(90).optional(),
...
/** Swamp extension model for Cloudflare Backtests. Registered at `@swamp/cloudflare/cloudforce-one/backtests`. */
export const model = {
  type: "@swamp/cloudflare/cloudforce-one/backtests",
  version: "2026.09.15.1",
  globalArguments: GlobalArgsSchema,
  inputsSchema: InputsSchema,
  resources: {
    state: {
      description: "Backtests resource state",
  ...
  methods: {
    create: {
      description: "Create a Backtests",
      arguments: z.object({}),
      execute: async (_args: Record<string, never>, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
          "/cloudforce-one/v2/priority-intelligence/interests/backtests";
        const body: Record<string, unknown> = {};
        if (g.as_of !== undefined) body.as_of = g.as_of;
        if (g.backtest_days !== undefined) body.backtest_days = g.backtest_days;
    ...
    get: {
      description: "Get a Backtests",
      arguments: z.object({
        id: z.string().describe("The ID of the Backtests"),
      }),
    ...
    lookup: {
      ...
      execute: async (_args: Record<string, never>, context: any) => {
        ...
        if (g.backtest_days !== undefined) {
          filters.push(["backtest_days", String(g.backtest_days)]);
        }
        if (g.candidate_limit !== undefined) {
        ...
        if (matches.length === 0) {
          ...
          throw new Error(`No backtests found matching filters: ${filterDesc}`);
        }
        if (matches.length > 1) {
          const filterDesc = filters.map(([k, v]) =>
            `${k}=${JSON.stringify(v)}`
    ...
    adopt: {
      ...
      arguments: z.object({
        id: z.string().describe("The ID of the Backtests to import"),
      }),
      execute: async (args: { id: string }, context: any) => {
        const g = context.globalArgs;
        const endpoint = "/accounts/" + g.account_id +
    ...
    sync: {
      description: "Sync Backtests state from Cloudflare",
      arguments: z.object({
        identifier: z.string().describe(
          "Target a specific Backtests by id (e.g. one discovered by list)",
        ).optional(),
      }),
